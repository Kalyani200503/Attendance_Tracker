...
function createInput(cell, studentIndex) {
  ...
  input.addEventListener("input", () => {
    ...
    if (value === "P") input.style.backgroundColor = "green";
    else if (value === "A") input.style.backgroundColor = "red";
    else if (value === "L") input.style.backgroundColor = "yellow";
...
function calculatePercentage(studentIndex) {
  const row = tableBody.rows[studentIndex];
  let presentCount = 0;
